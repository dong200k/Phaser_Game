...
export default class HomingMissile2 extends EffectLogic{
    effectLogicId = "Homing-Missile-2"
    ...
    public useEffect(playerState: Player, gameManager: GameManager, tree: WeaponUpgradeTree, playerBody: Matter.Body, mouseData: {mouseX: number, mouseY: number}){
        ...
        function spawnProjectile(angle: number){
            let rotatedVelocity = MathUtil.getRotatedSpeed(velocity.x, velocity.y, projectileSpeed, angle)
