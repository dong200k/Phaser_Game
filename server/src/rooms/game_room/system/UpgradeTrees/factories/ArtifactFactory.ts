...
export default class ArtifactFactory{
    ...
    static createUpgradedHermesBoot(){
        let artifact = WeaponUpgradeFactory.createUpgrade('upgrade-a4275241-dc56-4ea3-88cc-775c58bd64ce', false)?.root as Node<WeaponData>
    ...
    static createUpgradeFrostGlaive(){
        let artifact = WeaponUpgradeFactory.createUpgrade('upgrade-6c21dc6f-d21f-430d-b31a-93ca9583d842', false)?.root as Node<WeaponData>
        ArtifactManager.selectAllUpgrades(artifact)
    ...
    static createDemo(){
        let artifact = WeaponUpgradeFactory.createUpgrade('upgrade-f831783f-9c3b-40fb-aa62-4e29dfe84664', false)?.root as Node<WeaponData>
        ArtifactManager.selectAllUpgrades(artifact)
    ...
    static createMaxedArtifact(id: string){
        let artifact = WeaponUpgradeFactory.createUpgrade(id)?.root as Node<WeaponData>
        ArtifactManager.selectAllUpgrades(artifact);
        return artifact
    }
}